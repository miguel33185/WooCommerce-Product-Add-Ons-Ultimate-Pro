(function($) {
	...
	var calculations = {
		...
		init: function() {
			$( 'body' ).one( 'keyup input change paste', '.pewc-number-field.pewc-calculation-trigger', this.recalculate );
			$( 'body' ).on( 'keyup input change paste', '.qty', this.recalculate );
			$( 'body' ).on( 'keyup input change paste', 'form.cart .pewc-item.pewc-calculation-trigger, .pewc-form-field.pewc-calculation-trigger', this.recalculate );
